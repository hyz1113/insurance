      ...
      <div class="bgf p-10 ">
        ...
        <el-form-item label="性别">
          <el-radio-group
            ...
            placeholder="请选择性别"
          >
            <el-radio :label="1" class="w-50">男</el-radio>
            <el-radio :label="2" class="w-50">女</el-radio>
          </el-radio-group>
        </el-form-item>
      ...
      <div class="bgf p-10 m-t-10 no-bottom">
        ...
        <div class="m-l-50">
          <el-radio-group v-model="form.medicalSafe" size="small">
            <el-radio label="1" class="w-50">有</el-radio>
            <el-radio label="2" class="w-50">无</el-radio>
          </el-radio-group>
        </div>
      </div>
