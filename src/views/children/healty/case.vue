  ...
  <div>
    ...
    <div class="bgf p-10">
      ...
      <div class="article-block">
        ...
        严肃提醒：买任何商业保险前，先把少儿医保给办喽。大病小病、门诊住院，都能报销一些。手握医保，买商业医疗险也更便宜。
        <p class="g-error">
          【您的孩子已有一老一小少儿医保，不要忘记续保即可】（此句话为动态显示或隐藏）
        </p>
      </div>
    </div>
    ...
    <div class="bgf p-10 m-t-10">
      ...
      <div class="title text-center"><b class="b">不建议给孩子买什么保险？</b></div>
      ...
      <div class="row-align-center ">
        ...
        <div class="column-align-left">
          ...
          <p class="f-12 lh20 m-t-10">太贵，不如把保额做高，保障做足，省下来的钱拿去理财能赚更多</p>
        </div>
      </div>
      <div class="row-align-center ">
        <div class="column-align-left">
          <el-button type="success" size="mini" round>长期意外险</el-button>
          <p class="f-12 lh20 m-t-10">每年花几十块钱就能搞定的事，没必要花一两千</p>
        </div>
        <div class="column-align-left">
          <el-button type="success" size="mini" round>组合型保险</el-button>
          <p class="f-12 lh20 m-t-10">寿险、意外险、医疗险、重疾险等捆绑销售的保险，容易买到【歪瓜裂枣】、多话冤枉钱</p>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="bgf p-10 m-t-10">
      ...
      <base-table showSummary=true :tableConfig="tableConfig" :tableData="tableData"></base-table>
